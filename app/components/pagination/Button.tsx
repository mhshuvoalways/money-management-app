...
const Button: React.FC<Props> = ({ place }) => {
  ...
  return (
    <IconComponent className="size-8 cursor-pointer bg-white dark:bg-slate-700 flex justify-center items-center p-2 rounded-full shadow-sm hover:border border-primary transition" />
  );
};
